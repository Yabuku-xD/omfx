...
pub const virt = @import("cli/virt.zig");
pub const diffview = @import("cli/diffview.zig");
pub const modal = @import("cli/modal.zig");
pub const toast = @import("cli/toast.zig");
pub const progress = @import("cli/progress.zig");
pub const askprev = @import("cli/askprev.zig");
pub const codeview = @import("cli/codeview.zig");
pub const uxcopy = @import("cli/uxcopy.zig");
...
pub const ide = @import("core/ide.zig");
pub const plugins = @import("core/plugins.zig");
