...
pub const Name = enum {
    ...
    pub fn isExplore(self: Name) bool {
        return switch (self) {
            .read, .list, .grep, .glob, .semantic_search, .file_info, .board, .todo, .job, .read_result => true,
    ...
    pub fn isSensitive(self: Name) bool {
        return switch (self) {
            .read, .glob, .grep, .web_fetch, .web_scrape, .web_search, .ask_user, .list, .file_info, .semantic_search, .memory, .open_file, .browser, .board, .todo, .job, .read_result => false,
    ...
    pub fn blockedInPlan(self: Name) bool {
        return switch (self) {
            .read, .list, .grep, .glob, .semantic_search, .file_info, .board, .web_fetch, .web_scrape, .web_search, .ask_user, .memory, .bash, .todo, .job, .read_result => false,
    ...
    pub fn isRoutineWrite(self: Name) bool {
        return switch (self) {
            ...
            .read, .bash, .glob, .grep, .list, .delete, .rename, .file_info, .open_file, .semantic_search, .web_fetch, .web_scrape, .web_search, .ask_user, .memory, .browser, .peer, .board, .mcp, .compact, .todo, .job, .read_result => false,
        };
    }
    ...
    pub fn needsVerify(self: Name) bool {
        return switch (self) {
            ...
            .read, .bash, .glob, .grep, .list, .copy, .mkdir, .delete, .rename, .file_info, .open_file, .semantic_search, .web_fetch, .web_scrape, .web_search, .ask_user, .memory, .browser, .peer, .board, .mcp, .compact, .todo, .job, .read_result => false,
        };
    }
    ...
    pub fn needsAttach(self: Name) bool {
        return switch (self) {
            ...
            .bash, .glob, .grep, .list, .copy, .mkdir, .delete, .rename, .file_info, .open_file, .semantic_search, .web_fetch, .web_scrape, .web_search, .ask_user, .memory, .browser, .peer, .board, .mcp, .compact, .todo, .job, .read_result => false,
        };
    }
